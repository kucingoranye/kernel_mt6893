...
static apk_sign_key_t apk_sign_keys[] = {
    ...
    { EXPECTED_SIZE_KITTI, EXPECTED_HASH_KITTI }, // terebiko/KittiSU
    { EXPECTED_SIZE_AGNES, EXPECTED_HASH_AGNES }, // Yakayna/AgnesSU
    { EXPECTED_SIZE_XXKSU, EXPECTED_HASH_XXKSU } // backslashxx/kernelsu
#ifdef EXPECTED_SIZE
